...
export class AccountsComponent implements OnInit {
  ...
  ngOnInit() {
    this.loading = true;
    this.accountService
      .getAllAccountsByIdentityId(this.identityId)
        ...
        next: (response) => {
          ...
          body.Resources.forEach((resource: any) => {
            if (!resource.applicationDisplayName) {
              resource.applicationDisplayName =
                resource.application.displayName;
            }
          });

          this.accounts = body.Resources.filter(
            (resource: any) => resource.active
          );
    ...
    this.employeeService
      ...
      .subscribe({
        next: (response) => {
          ...
          body.Resources.forEach((resource: any) => {
            this.users.push({
              label: resource.displayName.slice(0, 30).toString(),
    ...
    this.applications = [
      { label: 'Salesforce', value: 'ac12000290eb1baf8190f0a73ef80926' },
    ];
  }
