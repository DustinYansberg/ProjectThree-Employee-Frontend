    ...
    ngOnInit() {
        ...
        .subscribe({
            next: (response) => {
                ...
                this.employeeDetails = new EmployeeDetail(employeeResponse.displayName, employeeResponse.value, employeeResponse.$ref, employeeResponse.accounts, employeeResponse.roles, employeeResponse.entitlements);
